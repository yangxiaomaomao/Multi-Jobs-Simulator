...
class Jaca():
    ...
    def compute_compatibility(self, job:Job, candi:list, job_dep_node:dict):
        ...
        load_factor = dict()
        # print(machine_load_dict,"kkk")
        # for k,v in machine_load_dict.items():
        #     print(k,v)
    ...
    def compute_single_job_score(self, job:Job, node_info:dict, label_counter:dict, job_dep_node:dict):
        ...
        pending_time = self.gv.get_global_time() - job.arrive_ts

        scale_score = jaca_min_score
        # if pending_time >= job.iter_time * job.iter_num * 0.8:
        #     scale_score = jaca_min_score / 1.5
        # elif pending_time >= job.iter_time * job.iter_num * 1.2:
        #     scale_score = jaca_min_score / 1.8
            
    
        job.jaca_score = scale_score
