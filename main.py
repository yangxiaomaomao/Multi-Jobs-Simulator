...
parser.add_argument('-gd2', '--gandiva-2', default=0.25, type=float, help="the gandiva-2 affinity proportion")
parser.add_argument('-gd4', '--gandiva-4', default=0.25, type=float, help="the gandiva-4 affinity proportion")
parser.add_argument('-gd8', '--gandiva-8', default=0.25, type=float, help="the gandiva-8 affinity proportion")
# tiresias
...
gv = global_var(args.scale_factor, args.division, args.machine_num, args.gpus_per_machine, 
                ...
                args.gandiva_1, args.gandiva_2, args.gandiva_4, args.gandiva_8,
                args.tiresias_skew,
