...
if not replace:
    all_trace_result_dir = "result_anti_tiresias"
    baseline_list = [
        "aef-te",
        "slf-te",
        "spf-te",
    ...
    all_trace_result_dir = "result_anti_tiresias_replace"
    baseline_list = [
        "jaca-load_balance",
        "jaca-gandiva",
        "jaca-consolidate",
...
if gem == 4:
    ...
    pcie_cap = 32 * 1000 # MBps for 16 * pcie4.0
#nic_cap_list = np.array([10]) / 8 * 1000 # 5-10-15-20-25
nic_cap  = 25 / 8 * 1000 # MBps, 8.98819 represent the 10Gbps ethlink, /8 is to tranfer Gbps to GBps
