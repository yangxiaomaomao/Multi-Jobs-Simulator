...
if not replace:
    all_trace_result_dir = "result_anti_fifo"
    baseline_list = [
        # "aef-te",
        # "slf-te",
        # "spf-te",
    ...
    all_trace_result_dir = "result_anti_fifo_replace"
    baseline_list = [
        "jaca-load_balance",
        "jaca-gandiva",
        "jaca-consolidate",
...
nic_cap  = 30 / 8 * 1000 # MBps, 8.98819 represent the 10Gbps ethlink, /8 is to tranfer Gbps to GBps
